  ...
  return (
    <div className="bg-white py-10 px-5">
      ...
      <p className="text-center lg:w-[90%] m-auto">
        ...
        transaction has been successfully processed {name}, and you are now the
      ...
      <div className="mt-20">
        ...
        <div className="sm:flex gap-5 justify-center items-center">
          ...
          <div className="sm:mt-0 mt-5">
            <a
              href="https://explorer.solana.com/address/GS2kEkuQiU8XiU3UbYBUb189CX2dt6LXgKMGXpKiHNfr?cluster=devnet"
              target="_blank"
        ...
        <div className="sm:flex gap-5 justify-center items-center mt-10">
          ...
          <div className="sm:mt-0 mt-5">
            <a
              href="https://explorer.solana.com/tx/3GYZRE5VTNyiSLzLruPYVUttJQBjbwRRumAJ4deGiGGcsVNXhb4j1fg7two47GDCZYNUyuQtL1GC4N2Ch2kK8eA?cluster=devnet"
              target="_blank"
              className="px-5 py-3 submit-button"
            >
              Confirm Transaction
